...
public class Robot extends TimedRobot {
    ...
    @Override
    public void disabledInit() { //spelling
    ...
    public void autonomousInit() {
        m_autonomousCommand = m_robotContainer.getAutonomousCommand(); //spelling

        if (m_autonomousCommand != null) {
            m_autonomousCommand.schedule(); //spelling
        }
    }
    ...
    } //missing another currly bracket and an empty line
}
